   ...
   // public MultiAimConstraint _constraint_spine2;
    ...
    public void OnReceive(string name)
    {
        ...
        else
        {
            ...
            GameObject  scene = character.gameObject.transform.Find("ScèneroomAgent2").gameObject;
            GameObject scene_s1 = character.gameObject.transform.Find("roomAgent1").gameObject;
            GameObject scene_food_s1 = scene_s1.gameObject.transform.Find("Food").gameObject;
            GameObject scene_food = scene.gameObject.transform.Find("sceneFood").gameObject;
            GameObject target;
            //if(name.contains("S2){
                // if(name.Contais("C1"){}
            ...
            //}
            //else(name.contains("S1"){
            //
            //
            //}
            if (name.Contains("C2"))
            {
                GameObject scene_food_cagette_c2 = scene_food.gameObject.transform.Find("CagetteC2").gameObject;
                target = scene_food_cagette_c2.gameObject.transform.Find(name).gameObject;
            }
            else if (name.Contains("null"))
            {
                Debug.Log("NULL FOUND");
                target= scene_food.gameObject.transform.Find(name).gameObject;
            }
            else
            {
                GameObject scene_food_cagette = scene_food.gameObject.transform.Find("CagetteC1").gameObject;
                target = scene_food_cagette.gameObject.transform.Find(name).gameObject;
                Debug.Log(target);
            }

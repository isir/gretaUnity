...
namespace IBM.Watson.Examples
{
    public class ExampleAssistantV2 : MonoBehaviour
    {
        ...
        public void sendMessage_Watson(string msg) { 

        var input0 = new MessageInput()
        {
            Text = msg,
            ...
            service.Message(OnMessage, assistantId, sessionId, input: input0);
        }
       ...
       public void SendMessage()
       {
           ...
           string text = this.GetComponent<ExampleTextToSpeechV1>().textInput.text;

           Log.Debug("ExampleAssistantV2.RunExample()", text);
        ...
        */
        ...
        private void OnMessage0(DetailedResponse<MessageResponse> response, IBMError error)
        {
            ...
            this.GetComponent<ExampleTextToSpeechV1>().textInput.text = response.Result.Output.Generic[0].Text;
            messageTested0 = true;
        ...
        {      
            ...
            this.textInput.text = response.Result.Output.Generic[0].Text;
            //GetComponent<OscJack.OscPropertySender>().Send();
